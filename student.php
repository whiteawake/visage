...
<html>
  ...
  <body>
    <div class="output">
      <span class="name">VISAGE | STUDENTS</span>
    </div>
    <form method="post" action="student_engine.php">
      ...
      <input type="text" class="message" name="message"/><br /><br />
        <div class="output">
          <span class="age">Email to: <span class="emailout">_</span>.</span>
        </div>
        <div class="output">
          <span class="name">From <span class="nameout2">_</span></span>
          <span class="age">at <span class="emailout2">_</span>@student.REDACTED.wa.edu.au.</span>
        </div>
        <div class="output">
