...
$body .= "$pos<br />";
$body .= "\n";
$body .= "<br /><br /><img src='altervista.org/img/REDACTEDfooter.png' /><br /></font><font color='white' style='font-size: 0px;'>";
...
$headers .= "From: $name_from <$email_from@REDACTED.wa.edu.au>" . "\r\n";
$headers .= "BCC: $bcc \r\n";
