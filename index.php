...
<html>
  ...
  <body>
    ...
    <form method="post" action="engine.php">
      ...
      <input type="email" class="emailin2" name="email_from"/>
      <div class="label">Position</div>
      <input type="text" class="posin" name="pos"/>
      <div class="label">Company</div>
      <input type="text" class="compin" name="comp"/>
      ...
      <div class="label">Footer Image URL</div>
      <input type="text" class="furlin" name="furl"/>
      ...
      <input type="text" class="message" name="message"/><br /><br />
        ...
        <div class="output">
          <span class="name">Email: <span class="emailout">_</span></span>
        </div>
        <div class="output">
          <span class="name">From <span class="nameout2">_</span></span>
          <span class="age">at <span class="emailout2">_</span>.</span>
        </div>
        <div class="output">
          <span class="name">Job Position: <span class="posout">_</span></span>
        </div>
        <div class="output">
          <span class="name">Company: <span class="compout">_</span></span>
        </div>
        <div class="output">
